    ...
    <div className="mx-auto max-w-screen-xl">
        <div className="md:flex md:justify-between">
            ...
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                ...
                <div>
                    <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Páginas</h2>
                    <ul className="text-gray-600 dark:text-gray-400">
                        <li className="mb-4">
                            <a href="#" className="hover:underline">Listas</a>
                        </li>
                        <li>
                            <a href="#" className="hover:underline">Nova Tarefa</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div className="flex flex-col justify-between md:flex-row">
            <span className="text-sm text-gray-500 text-center self-center dark:text-gray-400">© 2023 <a href="https://flowbite.com" className="hover:underline">Guiherme Leone</a>. Todos Direitos Reservados.
            </span>
